...
# Either 
# 1) Use this code + copy the code from basicsim_sim_logic and just run this 
#     code locally without Sacred or 
# 2) Run the experiment through Sacred within this script (using basicsim_run_one)
#     and read in the saved information somehow before plotting
