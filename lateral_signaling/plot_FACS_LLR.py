...
metadata_res_fname = os.path.join(data_dir, "analysis/FACS_perturbations_LLR_results.csv")
...
#    n_nbins = 5
    ...
    data = [pd.read_csv(os.path.join(FACS_dir, f)).squeeze() for f in metadata_res.filename]
