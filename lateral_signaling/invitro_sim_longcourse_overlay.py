...
sim_dir    = os.path.abspath("../data/sim_data/20220113_increasingdensity/sacred")
prop_fname = os.path.abspath("../data/propagation_data/singlespot_timeseries.csv")
save_dir   = os.path.abspath("../plots")
fpath      = os.path.join(save_dir, "invitro_sim_longcourse_overlay_")
fmt        = "png"
dpi        = 300
